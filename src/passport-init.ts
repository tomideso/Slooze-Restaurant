...
const opts = {
  ...
  jwtFromRequest: ExtractJwt.fromExtractors([ExtractJwt.fromUrlQueryParameter("authorization"), ExtractJwt.fromAuthHeaderAsBearerToken()]),
...
passport.use(
  new JwtStrategy(opts, async (req: Request, jwtPayload: jwt.JwtPayload, done: callback) => {
